...
public class TestAPI : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async void Check32Cheeps()
    {
     ...
     [Fact]
    public async void Check32CheepsOnPage2()
    {
        //arange 
        var response = await _client.GetAsync("/?page=2");
        response.EnsureSuccessStatusCode();
    ...
    [Fact]
    public async void AutherHas32Cheeps(){
        //Arrange  
    ...
    [Fact]
    public async void AutherHas32CheepsPage2(){
        //Arrange  
    ...
    [Fact]
    public async void CheepsOnPage1IsNotTheSameAsPage2Author(){
        //Arrange  
        //Page 1
        var response_Page1 = await _client.GetAsync("/Jacqualine Gilcoine/?page=1");
        response_Page1.EnsureSuccessStatusCode();
        //Page 2
        var response_Page2 = await _client.GetAsync("/Jacqualine Gilcoine/?page=2");
        response_Page2.EnsureSuccessStatusCode();
        //Act 
        var content_Page1 = await response_Page1.Content.ReadAsStringAsync();
        var content_Page2 = await response_Page2.Content.ReadAsStringAsync();
        //Assert
        Assert.NotEqual(content_Page1, content_Page2);
    }
    [Fact]
