...
//         System.Console.WriteLine("Connection string: "+_msSqlContainer.GetConnectionString());
...
//                 var descriptor = services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<ChirpDBContext>));
...
//                 db = scope.ServiceProvider.GetRequiredService<ChirpDBContext>();
